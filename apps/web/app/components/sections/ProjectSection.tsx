    ...
    <SectionShell title={title}>
      <div className="rounded-xl border border-gray-200 dark:border-gray-700 p-6 sm:p-8">
        ...
        <div className="mb-6 flex items-start justify-between gap-4">
          ...
          {data.image && (
            // biome-ignore lint/performance/noImgElement: image path/URL comes from portfolio.json
            <img
              src={data.image}
              alt={data.name}
          ...
          {data.cardImage && (
            <div className="shrink-0 self-start sm:self-center">
              <div className="relative -rotate-2 hover:rotate-0 transition-transform duration-300 ease-out">
                ...
                <div
                  className="relative rounded-2xl overflow-hidden w-40 sm:w-44 border border-gray-200 dark:border-gray-700 shadow-md"
