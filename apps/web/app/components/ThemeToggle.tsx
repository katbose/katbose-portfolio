...
const AnimatedThemeToggler = lazy(() =>
  import("./ui/animated-theme-toggler").then((module) => ({
    default: module.AnimatedThemeToggler,
  })),
);
...
export function ThemeToggle() {
  ...
  return (
    <Suspense
      fallback={<div className="h-9 w-9 rounded-full animate-pulse bg-gray-100 dark:bg-gray-800" />}
    >
